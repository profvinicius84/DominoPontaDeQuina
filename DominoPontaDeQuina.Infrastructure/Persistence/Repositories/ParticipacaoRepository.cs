...
public sealed class ParticipacaoRepository(DominoDbContext db) : IParticipacaoRepository
{
    /// <inheritdoc />
    public async Task AdicionarAsync(ParticipacaoPartida participacao, Guid partidaId, Guid jogadorId, CancellationToken cancellationToken = default)
    {
